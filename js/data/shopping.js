...
export const PRICES = {
  ...
  'Sardines (boîte)': { unit: 'boîte', price: 0.49 },
  ...
  'Graines de tournesol': { unit: 'kg', price: 2.49 },
...
const FOOD_15 = [
  ...
  { name: 'Thon (boîtes)', qty: 4, unit: 'boîtes', cat: 'conserves', priceKey: 'Thon (boîte)' },
  { name: 'Sardines (boîtes)', qty: 6, unit: 'boîtes', cat: 'conserves', priceKey: 'Sardines (boîte)' },
  { name: 'Fromage blanc 0 %', qty: 2.5, unit: 'kg', cat: 'laitiers', priceKey: 'Fromage blanc 0 %' },
  ...
  { name: 'Épinards (surgelés)', qty: 0.8, unit: 'kg', cat: 'legumes', priceKey: 'Épinards' },
  ...
  { name: 'Graines de tournesol', qty: 0.15, unit: 'kg', cat: 'graisses', priceKey: 'Graines de tournesol' },
];
